...
//         //     Mail::to($clubUser->email)->send(new \App\Mail\RiderApprovalRequest($rider));
//         // }
...
//         //Mail::to($riderUser->email)->send(new \App\Mail\RiderApproved($rider));
...
//     {
//         $rider = Rider::find($id);
//         $rider->is_approved_by_club = false;
//         $rider->save();
