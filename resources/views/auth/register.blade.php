...
<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Role Description -->
        <div id="role-description" class="mt-4 text-gray-600 dark:text-gray-400"></div>
    ...
    <script>
        function updateRoleDescription() {
            const roleDescriptions = {
                'club': 'この役割は、乗馬クラブの管理を行うためのものです。',
                'rider': 'この役割は、競技に参加する選手のためのものです。'
            };
            
            const role = document.getElementById('role').value;
            const description = roleDescriptions[role] || '';
            
            document.getElementById('role-description').innerText = description;
        }
    </script>
</x-guest-layout>
